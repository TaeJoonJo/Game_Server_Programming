...
void ProcessPacket(int ci, unsigned char packet[])
{
	...
	default: cout << "Error Type : " << etype << endl;
...
void Adjust_Number_Of_Client()
{
	...
	if (high_resolution_clock::now() < last_connect_time + 10ms) return;
